 ...
 * @Created at 2021/11/3 16:04
 * @Version 1.0
 * @Description 危险权限和特殊权限常量集，参考 {@link Manifest.permission}
 */
...
object Permission {
    ...
    val NOTIFICATION_SERVICE = "android.permission.NOTIFICATION_SERVICE"
     ...
     *
     * 为了 Android 12 以下兼容版本，请在清单文件中注册 [Manifest.permission.BLUETOOTH_ADMIN] 权限
     * 还有 Android 12 以下设备，获取蓝牙扫描结果需要模糊定位权限，框架会自动在旧的安卓设备上自动添加此权限进行动态申请
     */
    val BLUETOOTH_SCAN = "android.permission.BLUETOOTH_SCAN"

    /**
     * 蓝牙连接权限（需要 Android 12.0 及以上）
     *
     * 为了 Android 12 以下兼容版本，请在清单文件中注册 [Manifest.permission.BLUETOOTH] 权限
     */
    val BLUETOOTH_CONNECT = "android.permission.BLUETOOTH_CONNECT"
     ...
     */
    val BLUETOOTH_ADVERTISE = "android.permission.BLUETOOTH_ADVERTISE"
     ...
     */
    val ACCESS_MEDIA_LOCATION = "android.permission.ACCESS_MEDIA_LOCATION"
    ...
    val ACTIVITY_RECOGNITION = "android.permission.ACTIVITY_RECOGNITION"
    ...
    val ACCEPT_HANDOVER = "android.permission.ACCEPT_HANDOVER"
